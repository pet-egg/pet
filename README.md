...
5. 실행 중이나 **다른 앱이 앞에 있음**(백그라운드) → **waiting(얼음)**
6. Claude가 앞에 있고 할 일 없음 → **idle(잠듦)**

즉 "Dock에서 Claude 앱을 앞으로 꺼내 쓰는 동안"은 잠듦/달리기/헤롱헤롱으로, **승인을 기다리거나 다른
데로 넘어가 Claude를 놔두면** 얼음으로 얼려둡니다.
