...
- **신청받은 쪽**에는 처음부터 가운데 모달이 뜨는 게 아니라, 펫 **오른쪽 위에 작은 흰색 "Challenge" 말풍선**이 **10초간** 뜹니다. 이 말풍선을 **누르면** 그때 예전처럼 가운데 **수락/거절 모달**이 뜹니다. 누르지 않고 10초가 지나면 말풍선은 조용히 사라지고, 신청자 쪽 카운트다운이 끝나며 "응답하지 않음"으로 정리됩니다.
